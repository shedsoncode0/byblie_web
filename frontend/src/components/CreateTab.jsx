...
const CreateTab = () => {
  ...
  const handleBgColorchange = (value) => {
    setPost((prev) => ({ ...prev, bgColor: value }));
  };
  ...
  return (
    ...
    <div className='relative p-4 w-full h-full justify-center flex flex-1  md:h-auto'>
      {/* <!-- Modal content --> */}
      <div className='relative w-[700px] flex-1  p-4 bg-transparent dark:bg-gray-800 sm:p-5'>
        {/* <!-- Modal header --> */}
          ...
          <div className='w-full flex-1 mb-4 shadow-lg border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600'>
            ...
            <div className='px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800'>
              ...
              <textarea
                id='editor'
                rows='8'
                className='block text-center w-full px-0 text-lg border-0 dark:bg-gray-800 border-none outline-none focus:ring-0 text-white dark:placeholder-white'
