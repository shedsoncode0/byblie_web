...
const Header = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 border-b-2 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="#" className="flex items-center ">
          <img src="/logo.png" className="mr-3 h-7 sm:h-11" alt="F" />
        </a>
        <div className="flex items-center lg:order-2">
          ...
          >
            {signedIn ? "Home page" : "Get started"}
          </Link>
        </div>
        <div
