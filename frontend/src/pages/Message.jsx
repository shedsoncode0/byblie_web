        ...
        <section className="flex flex-col flex-none overflow-auto w-24 lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
            ...
            <div className="active-users flex flex-row p-2 overflow-auto w-0 min-w-full">
                <div className="text-sm text-center mr-4">
                    <button className="flex flex-shrink-0 focus:outline-none block bg-gray-200 text-gray-500 rounded-full w-20 h-20"
                            type="button">
            ...
            <div className="chat-footer flex-none">
                <div className="flex flex-row items-center p-4">
                    ...
                    <div className="relative flex-grow">
                        <label>
                            <input className="rounded-full py-2 pl-3 pr-10 w-full border border-gray-200 bg-gray-200 focus:bg-white focus:outline-none text-gray-600 focus:shadow-md transition duration-300 ease-in"
